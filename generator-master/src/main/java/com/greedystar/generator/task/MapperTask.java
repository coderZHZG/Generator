...
public class MapperTask extends BaseTask {
    ...
    public void run() throws IOException, TemplateException {
        ...
        mapperData.put("EntityName", GeneratorUtil.converTableName(tableName));
        mapperData.put("TableName", tableName);
        mapperData.put("TableShortName", GeneratorUtil.converTableName(tableName));
        mapperData.put("InsertProperties", GeneratorUtil.generateMapperInsertProperties(tableInfos));
        mapperData.put("InsertBarchProperties", GeneratorUtil.generateMapperInsertBatchProperties(tableInfos));
        ...
        mapperData.put("WhereParams",GeneratorUtil.generateListParams(tableInfos,GeneratorUtil.converTableName(tableName)));
        ...
        if (!StringUtil.isBlank(parentForeignKey)) { // 多对多
            ...
            mapperData.put("InsertBatchValues", GeneratorUtil.generateMapperInsertBatchValues(tableInfos,GeneratorUtil.converTableName(tableName)));
